...
class Biblioteca(Sujeto):
    ...
    def crear_libro(self, titulo, precio):
        ...
        libro.codigo = len(self._libros) + 1 # Estoy hay que sacarlo despues 
    ...
    def crear_socio(self, nombre : str, apellido : str, dni : int, telefono : int, mail : str, direccion : str):
...
def menu():
    ...
    while op != 0:
        ...
        match op:
            ...
            case "2":
                biblioteca.crear_socio('Juan', "Carlos", 421222, 3511233212, 'Juanchi_112@gmail.com', "Av. Carlos altamirano 1123")
                print()
            ...
            case "3":
                ...
                biblioteca.crear_socio('Juan', "Carlos", 421222, 3511233212, 'Juanchi_112@gmail.com', "Av. Carlos altamirano 1123")
                print(biblioteca.mostrar_socio(1))
                biblioteca.crear_prestamo(biblioteca.libros[1], date.today(), timedelta(days=10), biblioteca.socios[1])
